...
<link rel="stylesheet" href="<?php echo base_url('assets/css/color4.css'); ?>">
</head>
<body>
<div id="header">
  ...
  <div class="header_top">
    ...
    <div class="container">
      ...
      <div class="top_menu">
        ...
        <p><span class="fa fa-map-marker">&nbsp;</span>47DDC NY, 

15 West 47th Street, #1800, 
...
New York, NY 10036</p>
      ...
      <div class="hed_right">
        ...
        <ul>
          ...
          <li><span class="fa fa-phone"></span>International: 1-212-221-3735, Japan Number: 050-5532-5557 </li>

          <li><a href="mailto:info@47ddc.com"><span class="fa fa-envelope"></span>info@47ddc.com</a></li>
  ...
  <div class="header_bot">
    ...
    <div class="container">
      ...
      <div class="logo"> <a href="/home"><img alt="alt" src="<?php echo base_url('assets/images/logo.png'); ?>" ></a> </div>
        ...
        <nav id="navbar-collapse-1" class="navbar-collapse collapse">
          ...
          <li><a href="<?php echo base_url('home'); ?>"  >Home </a> </li>
            ...
            <li class="dropdown"><a href="<?php echo base_url('aboutus'); ?>"  >About Us </a> </li>
             ...
             <li class="<?php echo base_url('contactus'); ?>"><a href="#" >Contact Us</a></li>
             <li class="dropdown"><a href="#"  >Terms</a> </li>
